...
bool PADS_simpleInit(PADS *self)
{
  ...
  {
#if SERIAL_DEBUG
    SSerial_printf(self->serialDebug, "WSEN_PADS Communication success\n\r");
...
bool ITDS_simpleInit(ITDS *self)
{
  ...
  {
#if SERIAL_DEBUG
    SSerial_printf(self->serialDebug, "WSEN_ITDS Communication success\n\r");
    SSerial_printf(self->serialDebug, "DeviceID 0x%02X \n\r", deviceIdValue);
#endif
  }
  else
...
bool TIDS_simpleInit(TIDS *self)
{
  ...
  {
#if SERIAL_DEBUG
    SSerial_printf(self->serialDebug, "WSEN_TIDS Communication success\n\r");
    SSerial_printf(self->serialDebug, "DeviceID 0x%02X \n\r", deviceIdValue);
#endif
  }
  else
...
bool HIDS_simpleInit(HIDS *self)
{
  ...
  {
#if SERIAL_DEBUG
    SSerial_printf(self->serialDebug, "WSEN_HIDS Communication success\n\r");
    SSerial_printf(self->serialDebug, "DeviceID 0x%02X \n\r", deviceIdValue);
#endif
  }
  else
