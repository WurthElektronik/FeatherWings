...
#define DEVICE_PRIMARY_KEY_SLOT \
    0x00 /*Permanent Primary authentication key for ext sign*/
#define ECDH_KEY_SLOT \
    0x02 /*Updatable secondary private key for use as ephemeral key*/
...
#define AES_BLOCK_LENGTH \
    16 /*Length of each block for the AES encryption/decryption*/
